...
const mockProfile = {
  ...
  firstName: "Sarah",
  lastName: "Johnson",
  email: "sarah.j@hr.movicloudlabs.com",
  employeeId: "HR-2023-042",
  avatar: "SJ",
  college: "Stanford University",
  department: { name: "Human Resources" },
  project: { name: "Talent Acquisition & Management" },
  mentor: { name: "Director of HR" },
  startDate: "2023-01-15T00:00:00Z",
  endDate: "N/A",
  phone: "+1 (555) 123-4567",
  address: "456 Tech Avenue, San Francisco, CA",
  linkedIn: "linkedin.com/in/sarahjohnson",
  emergencyContact: { name: "Michael Johnson", phone: "+1 (555) 987-6543", relation: "Spouse" },
  bio: "Experienced HR professional dedicated to fostering a positive and productive work environment. Passionate about talent development and employee well-being.",
  performanceRatings: [
    { week: 1, rating: 5, note: "Excellent hiring metrics", date: "2024-09-07T10:00:00Z" },
    { week: 2, rating: 4, note: "Good progress on onboarding revamp", date: "2024-09-14T10:00:00Z" },
    { week: 3, rating: 5, note: "Outstanding team management", date: "2024-09-21T10:00:00Z" },
    { week: 4, rating: 4, note: "Solid performance overall", date: "2024-09-28T10:00:00Z" },
  ]
};
...
export default function HRProfile() {
  ...
  return (
    <PageWrapper>
      {/* Compact layout: gap-4 instead of gap-6, smaller text headers, tighter padding */}
          ...
          <div className="w-full lg:w-[35%] bg-white rounded-xl border border-[#E2E8F0] p-4 shadow-sm sticky top-4">
            <div className="flex flex-col items-center">
              ...
              <div className="flex gap-1.5 mt-2.5">
                <span className="bg-[#DCFCE7] text-[#16A34A] px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider">HR</span>
            ...
            <div className="bg-white rounded-xl border border-[#E2E8F0] p-4 sm:p-5 shadow-sm">
              ...
              <div className="flex items-center gap-3 bg-[#F8FAFC] p-3 rounded-lg border border-[#E2E8F0]">
                <div className="flex items-baseline gap-1">
                  <span className="text-2xl font-black text-[#0F172A]">4.5</span>
                  <span className="text-xs font-bold text-[#64748B]">/5</span>
                </div>
                <div className="w-px h-6 bg-[#CBD5E1]"></div>
                <div>
                  <div className="flex gap-0.5 text-amber-400 text-sm mb-0.5">{'★'.repeat(4)}{'☆'.repeat(1)}</div>
